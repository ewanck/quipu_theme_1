...
//  if ($node->field_subtitles_es_complete == 1) {
//  $i = 0;
//  $sub_set = array();
...
//  if ($node->field_subtitles_en_complete == 1) {
//  $i = 0;
...
<?php endif; ?>
  <?php if ($title_prefix || $title_suffix || $display_submitted || $unpublished || !$page && $title): ?>
    <header>
      <div class="play_button icon-internet" data-nid="<?php print $node->nid; ?>"></div>
  ...
  <div class="story_player">
    <audio id="audio-<?php print $node->nid; ?>">
      <source src="<?php print file_create_url($content['field_audiomessage']['#items'][0]['uri']); ?>" type="audio/mpeg" />
    </audio>
    <?php
